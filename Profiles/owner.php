                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="list-car-form">
                                <div class="mb-3">
                                    <label for="carName" class="form-label">Car Name</label>
                                    <input type="text" class="form-control" id="carName" placeholder="e.g., Tata Nexon, Mahindra XUV300" required>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" id="carYear" min="2000" max="2025" placeholder="e.g., 2023" required>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="carSpecs" rows="3" placeholder="Enter details like mileage, engine capacity, features, etc." required></textarea>
                                </div>
                                
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label for="seatingCapacity" class="form-label">Seating Capacity</label>
                                        <input type="number" class="form-control" id="seatingCapacity" min="2" max="10" placeholder="e.g., 5" required>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="carPrice" min="500" placeholder="e.g., 1500" required>
                                </div>
                                
                                <div class="mb-3">
                                    <label for="carLocation" class="form-label">Car Location</label>
                                    <input type="text" class="form-control" id="carLocation" placeholder="e.g., Angul, Odisha" required>
                                </div>
                                
                                <div class="mb-3">
                                    <label for="carPhotos" class="form-label">Car Photos</label>
                                    <input type="file" class="form-control" id="carPhotos" multiple accept="image/*" required>
